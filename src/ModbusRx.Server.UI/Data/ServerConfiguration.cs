...
public sealed class ServerConfiguration
{
    ...
    /// <summary>Gets or sets the TCP port for the server.</summary>
    public int TcpPort { get; set; } = 502;

    /// <summary>Gets or sets the UDP port for the server.</summary>
    public int UdpPort { get; set; } = 503;

    /// <summary>Gets or sets the unit ID for the server.</summary>
    ...
    /// <summary>Gets or sets the simulation type.</summary>
    [MaxLength(20)]
    public string SimulationType { get; set; } = "Random";

    /// <summary>Gets or sets the simulation interval in milliseconds.</summary>
    public int SimulationIntervalMs { get; set; } = 1000;

    /// <summary>Gets or sets a value indicating whether the server auto-starts.</summary>
