...
public sealed class ModbusClientConfiguration
{
    ...
    /// <summary>Gets or sets the friendly name for this client.</summary>
    [Required]
    [MaxLength(100)]
    public string Name { get; set; } = string.Empty;

    /// <summary>Gets or sets the connection type (TCP, UDP, RTU, ASCII).</summary>
    [Required]
    [MaxLength(10)]
    public string ConnectionType { get; set; } = string.Empty;

    /// <summary>Gets or sets the IP address or COM port.</summary>
    [Required]
    [MaxLength(50)]
    public string Address { get; set; } = string.Empty;

    /// <summary>Gets or sets the port number or baud rate.</summary>
    public int Port { get; set; }

    /// <summary>Gets or sets the slave/unit ID.</summary>
    ...
    /// <summary>Gets or sets additional configuration as JSON.</summary>
