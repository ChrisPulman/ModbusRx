...
internal sealed class DebugLogger : ILogger
{
    ...
    /// <summary>Writes a log message with type information.</summary>
    /// <param name="message">The message to log.</param>
    ...
    /// <summary>Writes an exception with message.</summary>
    ...
    /// <summary>Writes an exception with message and type information.</summary>
    /// <param name="exception">The exception to log.</param>
    /// <param name="message">The message to log.</param>
    /// <param name="type">The type that generated the message.</param>
    /// <param name="logLevel">The log level.</param>
