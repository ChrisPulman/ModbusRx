...
public class ConfigurationService(ModbusServerContext context)
{
    ...
    /// <summary>Gets a client configuration by ID.</summary>
    ...
    /// <summary>Saves a client configuration.</summary>
    ...
    public async Task<ModbusClientConfiguration> SaveClientConfigurationAsync(ModbusClientConfiguration configuration)
    {
        ...
        {
            _ = context.ClientConfigurations.Update(configuration);
        }
    ...
    /// <summary>Deletes a client configuration.</summary>
    ...
    public async Task<bool> DeleteClientConfigurationAsync(int id)
    {
        ...
        _ = context.ClientConfigurations.Remove(configuration);
        await context.SaveChangesAsync();
        return true;
    }
    ...
    /// <summary>Saves the server configuration.</summary>
    /// <param name="configuration">The configuration to save.</param>
    /// <returns>The saved configuration.</returns>
    ...
    /// <summary>Gets enabled client configurations.</summary>
    /// <returns>A list of enabled client configurations.</returns>
    public Task<List<ModbusClientConfiguration>> GetEnabledClientConfigurationsAsync() => context.ClientConfigurations
            .Where(c => c.IsEnabled)
            .OrderBy(c => c.Name)
            .ToListAsync();

    /// <summary>Updates the enabled status of a client configuration.</summary>
    /// <param name="id">The configuration ID.</param>
