...
{
    /// <summary>Example for serial communication testing. Note: Requires physical hardware and won't work in CI environments.</summary>
    ...
    public static async Task TcpAsync()
    {
        ...
        var address = new IPAddress([ 127, 0, 0, 1]);
