...
/// <value>The start address.</value>
    ...
    public override string ToString()
    {
        ...
        return $"Write single holding register {Data![0]} at address {StartAddress}.";
    }
    ...
    public void ValidateResponse(IModbusMessage response)
    {
        ...
        var actualData = typedResponse.Data![0];
    ...
    protected override void InitializeUnique(byte[] frame)
    {
        ...
        Data = new((ushort)IPAddress.NetworkToHostOrder(BitConverter.ToInt16(frame, 4)));
    }
}
