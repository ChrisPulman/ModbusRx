...
#endif
{
    /// <summary>Provides ModbusUdpSlaveExtensions functionality.</summary>
    public static class ModbusUdpSlaveExtensions
    {
        /// <summary>Provides write adapters for UDP slave observable streams.</summary>
        /// <param name="slave">The slave stream.</param>
        extension(IObservable<ModbusUdpSlave> slave)
        {
            ...
            public IObservable<ModbusUdpSlave> WriteInputRegisters(ushort startAddress, IObservable<ushort[]> valuesToWrite)
            {
            ...
            /// <param name="valuesToWrite">The values to write.</param>
            /// <returns>Observable ModbusUdpSlave.</returns>
            public IObservable<ModbusUdpSlave> WriteHoldingRegisters(ushort startAddress, IObservable<ushort[]> valuesToWrite)
            {
                _ = slave.CombineLatest(
                    valuesToWrite,
            ...
            /// <param name="valuesToWrite">The values to write.</param>
            /// <returns>Observable ModbusUdpSlave.</returns>
            public IObservable<ModbusUdpSlave> WriteCoilDiscretes(ushort startAddress, IObservable<bool[]> valuesToWrite)
            {
                _ = slave.CombineLatest(
                    valuesToWrite,
            ...
            /// <param name="valuesToWrite">The values to write.</param>
            /// <returns>Observable ModbusUdpSlave.</returns>
            public IObservable<ModbusUdpSlave> WriteInputDiscretes(ushort startAddress, IObservable<bool[]> valuesToWrite)
            {
                _ = slave.CombineLatest(
                    valuesToWrite,
